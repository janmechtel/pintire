...
Element.prototype = Object.create(ContainerNode.prototype, {
  ...
  getElementsByTagName: { value: function getElementsByTagName(lname) {
      ...
      if (lname === '*')
      filter = function () {return true;};else
      if (this.isHTML)
      filter = htmlLocalNameElementFilter(lname);else
  ...
  getElementsByTagNameNS: { value: function getElementsByTagNameNS(ns, lname) {
      ...
      filter = function () {return true;};else
      if (ns === '*')
      filter = localNameElementFilter(lname);else
      if (lname === '*')
      filter = namespaceElementFilter(ns);else
