...
URLUtils.prototype = Object.create(Object.prototype, {
  ...
  protocol: {
    get: function () {
      var url = this._url;
      if (url && url.scheme) return url.scheme + ":";else
      return ":";
    },
    set: function (v) {
  ...
  host: {
    get: function () {
      ...
      return url.host + (url.port ? ":" + url.port : "");else
