...
function adjustSVGTagName(name) {
  ...
  return svgTagNameAdjustments[name];else
...
function HTMLParser(address, fragmentContext, options) {
    ...
    return insertElement(function (doc) {
      ...
      if (attrs) {
        for (var i = 0, n = attrs.length; i < n; i++) {
          var attr = attrs[i];
          if (attr.length === 2)
          elt._setAttribute(attr[0], attr[1]);else
          {
  ...
  function fosterParent(eltFunc) {
    ...
    if (elt.nodeType === Node.TEXT_NODE) {
      var prev;
      if (before) prev = before.previousSibling;else
    ...
    if (before)
    parent.insertBefore(elt, before);else
  ...
  function markup_declaration_open_state(c, lookahead, eof) {
    ...
    if (lookahead === "[CDATA[" && cdataAllowed()) {
      nextchar += 7;
  ...
  function initial_mode(t, value, arg3, arg4) {
    switch (t) {
      ...
      case 5: // DOCTYPE
        ...
        doc._quirks = true;else
        if (limitedQuirkyPublicIds.test(publicid) ||
        systemid !== undefined &&
        conditionallyQuirkyPublicIds.test(publicid))
        doc._limitedQuirks = true;
      ...
      case 2: // TAG
        switch (value) {
          ...
          case "select":
            ...
            parser === in_row_mode ||
            parser === in_cell_mode)
            parser = in_select_in_table_mode;else
  ...
  function in_table_mode(t, value, arg3, arg4) {
    ...
    switch (t) {
      case 1: // TEXT
        ...
        if (isA(stack.top, tablesectionrowSet)) {
          pending_table_text = [];
          originalInsertionMode = parser;
  ...
  function insertForeignToken(t, value, arg3, arg4) {
    ...
    switch (t) {
      ...
      case 2: // TAG
        ...
        if (current.namespaceURI === NAMESPACE.SVG) {
